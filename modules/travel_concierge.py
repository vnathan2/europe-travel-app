...
ITINERARIO_CHECKS = [
    {
        ...
        "actividades": [
            ...
            {"id": "pre_02", "hora": "10:00", "tipo": "transporte",
             ...
             "detalle": "Verificar: 3 pasaportes vigentes · tickets Air Europa UX176 (loc 8ULKTI) · voucher seguro Interseguro (A66-8JIEDM) · tickets de atracciones en PDF offline · billete EuroCity impreso en papel A4 (obligatorio) · app Omio con X7FNNK y JTHDBFR descargadas offline · extracto bancario de Jonathan impreso y sellado (cubre a los 3 como titular del hogar) para acreditar medios económicos en migración España (mín. €1.099 por persona, ~US$6.660 total al TC actual) · ⚠️ Sistema EES vigente desde abril 2026: en Madrid tomarán foto facial + huellas a los 3 (Camila incluida), ya no sellan pasaporte, prever tiempo extra en el control fronterizo", "costo": 0},
