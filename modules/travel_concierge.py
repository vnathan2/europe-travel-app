...
ITINERARIO_CHECKS = [
    {
        ...
        "actividades": [
            ...
            {"id": "pre_02", "hora": "La noche del 13 jul", "tipo": "transporte",
             ...
             "detalle": "✅ YA IMPRESO Y EN FOLDER dentro de la mochila Legion (cabina) · Verificar que estén todos: 3 pasaportes vigentes · billete EuroCity impreso en papel A4 (JTHDBFR, obligatorio) · extracto bancario Jonathan sellado · 3 cartas Bewijs van garantstelling de Janina (una por persona) · voucher seguro Interseguro (A66-8JIEDM) · tickets vuelo Air Europa UX176 (loc 8ULKTI) · confirmaciones de los 4 hoteles · tickets de atracciones en PDF descargados offline en el móvil (no hace falta imprimirlos) · ⚠️ Sistema EES: en Barajas tomarán foto facial + huellas a los 3 (Camila incluida), ya no sellan pasaporte, prever 30-45 min extra en migración · ⚠️ NO llevar en la maleta: carne o lácteos — prohibido ingresar a la UE", "costo": 0},
