...
ITINERARIO_CHECKS = [
    {
        ...
        "actividades": [
            ...
            {"id": "pre_02", "hora": "10:00", "tipo": "transporte",
             ...
             "detalle": "Verificar: 3 pasaportes vigentes · tickets Air Europa UX176 (loc 8ULKTI) · voucher seguro Interseguro (A66-8JIEDM) · tickets de atracciones en PDF offline · billete EuroCity impreso en papel A4 (obligatorio) · app Omio con X7FNNK y JTHDBFR descargadas offline · extractos bancarios impresos y sellados (Jonathan y Giovanna) para acreditar medios económicos en migración España (mín. €1.099 por persona)", "costo": 0},
            {"id": "pre_05", "hora": "08:00", "tipo": "transporte",
             "icono": "🏦", "nombre": "Ir al banco — extracto impreso (ANTES del 14 jul)",
             "detalle": "Ir al counter del banco (BCP/Interbank/BBVA) y pedir extracto de cuenta impreso y sellado · NO vale el descargado de internet ni el del cajero · uno por adulto (Jonathan y Giovanna) · pedirlo máximo 1 semana antes del viaje (entre 7-13 jul) · España exige acreditar mín. €1.099 por persona o €121.10/persona/día · llevar el extracto en el equipaje de mano", "costo": 0},
