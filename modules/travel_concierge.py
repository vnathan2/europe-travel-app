...
ITINERARIO_CHECKS = [
    {
        ...
        "actividades": [
            ...
            {"id": "pre_02", "hora": "10:00", "tipo": "transporte",
             ...
             "detalle": "Verificar: 3 pasaportes vigentes · tickets Air Europa UX176 (loc 8ULKTI) · voucher seguro Interseguro (A66-8JIEDM) · tickets de atracciones en PDF offline · billete EuroCity impreso en papel A4 (obligatorio) · app Omio con X7FNNK y JTHDBFR descargadas offline · extracto bancario de Jonathan impreso y sellado (cubre a los 3 como titular del hogar) para acreditar medios económicos en migración España (mín. €1.099 por persona, ~US$6.660 total al TC actual) · 3 cartas 'Bewijs van garantstelling' de Janina (familiar en Ámsterdam) — una por persona, prueba de alojamiento gratuito para los días en Ámsterdam, llevar impresas · ⚠️ Sistema EES vigente desde abril 2026: en Madrid tomarán foto facial + huellas a los 3 (Camila incluida), ya no sellan pasaporte, prever tiempo extra en el control fronterizo · ⚠️ NO llevar en la maleta: carne o lácteos de cualquier tipo (charqui, embutidos, quesos peruanos) — prohibido ingresar a la UE desde fuera; sí se permite fruta/verdura en cantidad limitada, miel hasta 2kg, pan/galletas/chocolate sin límite", "costo": 0},
            {"id": "pre_05", "hora": "08:00", "tipo": "transporte",
             "icono": "🏦", "nombre": "Ir al banco — extracto impreso (ANTES del 14 jul)",
             "detalle": "Jonathan va al counter de su banco tradicional (BCP/Interbank/BBVA/Scotiabank — NO Global66, no tiene counter físico en Perú) y pide extracto de cuenta impreso y sellado · cuenta en dólares está bien (España acepta 'su equivalente legal en moneda extranjera') · NO vale el descargado de internet, del cajero, ni de apps fintech · como Jonathan mantiene el hogar, su extracto cubre a Giovanna y Camila · pedirlo máximo 1 semana antes del viaje (entre 7-13 jul) · España exige acreditar mín. €1.099 por persona o €121.10/persona/día (total 3 personas: ~€6.176 ≈ US$6.660) · llevar el extracto en el equipaje de mano junto con DNI de los 3 para acreditar el vínculo familiar", "costo": 0},
