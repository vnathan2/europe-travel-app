...
RUTAS = [
{
    ...
    },
    {
        ...
        "estado": "⏳ Por reservar (compra mañana)",
        "consejos": [
            "Sin control de pasaportes (zona Schengen); llega ~30 min antes para abordar",
            "La Gare du Nord está en el centro de París, fácil en metro",
            "Trayecto corto (1h22): puedes llevar el desayuno",
    ...
    },
    {
        ...
        "precio_pp": "€38.70",
        "precio_familia": "€116.10 (incl. Omio Savings Pass −€12.90)",
        "precio_pen": "S/.~465",
        ...
        "consejos": [
            ...
            "1 transbordo fácil al final: Schiphol/Zuid → Amsterdam Centraal en tren local NS, frecuente",
            "Tarifa Saver: cambiable sin costo y reembolsable con €5 hasta el día antes",
            "Camila (15) viaja con tarifa joven (válida hasta 25 años)",
