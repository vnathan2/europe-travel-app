...
OFFLINE_FAQS: list[dict] = [
    {
        ...
        "respuesta": (
            ...
            "   - Madrid: +34 91 562 90 22 — Paseo del Pintor Rosales 30\n"
            "   - París: +33 1 42 65 25 10 — 14 Rue de Siam (nueva sede 2026)\n"
            "   - Bruselas: +32 2 641 87 60 — Av. des Arts 10-11\n"
            "   - Ámsterdam: +31 6 31945831 (emerg.), De Boelelaan 7; Embajada La Haya +31 70 365 3500\n"
    ...
    },
    {
        ...
        "respuesta": (
            ...
            "- **Madrid (España)**: Consulado General.\n"
            "  Tel: +34 91 562 90 22. Dir: Paseo del Pintor Rosales 30.\n"
            "- **París (Francia)**: Consulado General (nueva sede 2026).\n"
            "  Tel: +33 1 42 65 25 10. Dir: 14 Rue de Siam, 75116.\n"
            "- **Bruselas (Bélgica)**: Consulado General.\n"
            "  Tel: +32 2 641 87 60. Dir: Av. des Arts 10-11, 1210.\n"
            "- **Ámsterdam (Países Bajos)**: Consulado General.\n"
            "  Tel: +31 6 31945831 (emerg.). Dir: De Boelelaan 7.\n\n"
